...
<head>
    ...
    <link rel="stylesheet" href="../css/mantenimientomenor.css">
...
<body>
                ...
                <div class="column">
                    ...
                    <div class="form-group">
                        ...
                        <select id="tipo" name="tipo">
                            ...
                            <option value="Resanado">Resanado</option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="avance" name="avance" min="0" max="100" step="1" style="width: 100px;">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select id="espacio" name="espacio">
                            <option value=""></option>
                            <option value="primaria-heroes">Escuela Primaria Héroes de Chapultepec</option>
                        </select>
                    </div>
    ...
    <div class="container">
        ...
        <div style="text-align: center;">
            ...
            <a href="graficasreparacion.php" class="btn">Consultar Tipo reparación</a>
            <a href="graficasmantenimiento.php" class="btn">Consultar Tipo mantenimiento</a>
            <a href="graficasinstalacion.php" class="btn">Consultar Tipo instalación</a>
        </div>
    </form>
</div>
